...
outputs:
  ...
  lastal1_result:
    type: File
    outputSource: lastal1/maf
  lastal2_result:
    type: File
    outputSource: lastal2/maf
  lastsplit1_result:
    type: File
    outputSource: lastsplit1/splitmaf
  lastsplit2_result:
    type: File
    outputSource: lastsplit2/splitmaf
  mafconvert_result:
    type: File
...
steps:
  ...
  mafconvert:
    run: maf-convert.cwl
    in:
      maf1: lastsplit1/splitmaf
      maf2: lastsplit2/splitmaf
