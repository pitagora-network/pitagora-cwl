#!/bin/bash
# star-cufflinks_wf.sh [--id <path to id list>]  [--star-index <path to index directory>] [--cufflinks-annotation <path to annotation gtf file>] [--cwl <path to star-cufflinks_wf_pe.cwl>] [--yml <path to star-cufflinks_wf_pe.yaml.sample>]
#
set -e
