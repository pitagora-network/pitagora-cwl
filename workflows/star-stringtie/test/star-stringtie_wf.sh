#!/bin/bash
# star-stringtie_wf.sh <path to id list> <path to index directory> <path to annotation gtf file> <path to star-stringtie_wf_(se|pe).cwl> <path to star-stringtie_wf_(se|pe).yaml.sample>
#
set -e
