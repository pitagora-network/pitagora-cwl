#!/bin/bash
# star-stringtie_wf_pe.sh [--id <path to id list>] [--star-index <path to index directory>] [--stringtie-annotation <path to annotation gtf file>] [--cwl <path to star-stringtie_wf_pe.cwl>] [--yml <path to star-stringtie_wf_pe.yaml.sample>]
#
set -e
