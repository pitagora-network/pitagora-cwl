...
label: "TopHat is a fast splice junction mapper for RNA-Seq reads. [cwl for paired end]"
...
inputs:
  ...
  genome_index_base:
    ...
    type: string
  fq1:
    label: "The *_1 (left) read in FASTQ or FASTA format"
    doc: "The *_1 (left) read in FASTQ or FASTA format"
    type: File
    inputBinding:
      position: 2
  fq2:
    label: "The *_2 (right) read in FASTQ or FASTA format"
    doc: "The *_2 (right) read in FASTQ or FASTA format"
    type: File
    inputBinding:
      position: 3
